...
const DashboardHeader = () => {
  ...
  return (
  <Box
  sx={{ px: { xs: 2, md: 3 }, py: 3, background: "#F7F8FC", }} >
  {/* ================= TOP SECTION ================= */}

  <Box
    sx={{ display: "flex", justifyContent: "space-between", alignItems: { xs: "flex-start", lg: "center" }, flexDirection: { xs: "column", lg: "row" }, gap: 3,}}>
    {/* Greeting */}
